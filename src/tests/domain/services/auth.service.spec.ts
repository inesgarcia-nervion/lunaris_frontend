...
describe('AuthService', () => {
  ...
  it('should login and save token to sessionStorage when rememberMe=false', () => {
    ...
    const req = httpMock.expectOne('https://lunarisback-h2h2hjdeagbghwgq.italynorth-01.azurewebsites.net/auth/login');
  ...
  it('should login and save token to localStorage when rememberMe=true', () => {
    ...
    httpMock.expectOne('https://lunarisback-h2h2hjdeagbghwgq.italynorth-01.azurewebsites.net/auth/login').flush({ token: USER_TOKEN });
  ...
  it('should detect admin role from token on login', () => {
    ...
    httpMock.expectOne('https://lunarisback-h2h2hjdeagbghwgq.italynorth-01.azurewebsites.net/auth/login').flush({ token: ADMIN_TOKEN });
    expect(service.isAdmin()).toBe(true);
  ...
  it('register should POST to /users', () => {
    ...
    const req = httpMock.expectOne('https://lunarisback-h2h2hjdeagbghwgq.italynorth-01.azurewebsites.net/users');
    expect(req.request.method).toBe('POST');
  ...
  it('updateUser should PUT to backend with correct URL', () => {
    ...
    const req = httpMock.expectOne(
      'https://lunarisback-h2h2hjdeagbghwgq.italynorth-01.azurewebsites.net/users/username/alice'
    );
  ...
  it('updateUser should work without token (no Authorization header)', () => {
    ...
    const req = httpMock.expectOne('https://lunarisback-h2h2hjdeagbghwgq.italynorth-01.azurewebsites.net/users/username/user1');
  ...
  it('updateUser encodes special characters in username', () => {
    ...
    const req = httpMock.expectOne('https://lunarisback-h2h2hjdeagbghwgq.italynorth-01.azurewebsites.net/users/username/user%20name');
    req.flush({});
  });
